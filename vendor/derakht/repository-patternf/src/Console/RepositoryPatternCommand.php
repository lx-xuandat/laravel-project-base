...
namespace Xuandat\RepositoryPattern\Console;

use Illuminate\Support\Str;
use Illuminate\Console\Command;
use InvalidArgumentException;
use Xuandat\RepositoryPattern\Console\Generators\RepositoryEloquentGenerator;
use Xuandat\RepositoryPattern\Console\Generators\RepositoryInterfaceGenerator;
use Xuandat\RepositoryPattern\Console\Generators\RepositoryProviderGenerator;
use Exception;
